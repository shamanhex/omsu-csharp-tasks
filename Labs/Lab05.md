...
При выполнении задания нужно стремиться сделать код приложения легко читаемым другим программистом.
...
3. Создать иерархию классов для пунктов меню, выделить отдельно класс пункта меню (Task) и класс с вычислениями (например: FibonacсiCalc).
...
3. Проверить, что выделен базовый класс Task (имя может отличаться) для пункта меню и в класс вынесены номер меню и строки.
...
Название базового класса для пункта меню (Task) непринципиально и может быть выбрано студентом на своё усмотрение.
