...
7. Вывод должен форматироваться до 3 знаков после запятой (пример: 3,195).
...
12. Ввести корректные значения чисел в зависимости от формулы (должен отобразиться результат, и выполнен переход в меню).
